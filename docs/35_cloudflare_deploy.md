...
- Dostępne zmienne środowiskowe @.env.dist

2. Dostosuj projekt aby wspierać deployment na Cloudflare

3. Utwórz scenariusz CI/CD "master.yml" gdzie przeprowadzimy wdrożenie na istniejący projekt Cloudflare Pages. Bazuj na @test.yml ale w nowym scenariuszu nie testuj E2E.
