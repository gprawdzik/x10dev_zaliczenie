...
4. Tworzenie kompleksowego planu interfejsu API REST:
   ...
   - Zaprojektuj endpointy dla logiki biznesowej opisanej w PRD
   - Uwzględnienie paginacji, filtrowania i sortowania dla endpointów listy.
...
3. Zmapuj funkcje z PRD do potencjalnych endpointów API. Dla każdej funkcji rozważ co najmniej dwa możliwe projekty endpointów i wyjaśnij, który z nich wybrałeś i dlaczego.
