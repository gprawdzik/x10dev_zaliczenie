Przeprowadź integrację vue z backendem Astro na podstawie specyfikacji @auth-spec.md. Rozpocznij od analizy istniejącego kodu w kontekście najlepszych praktyk @shared.mdc, @frontend.mdc i @backend.mdc. Skup się na funkcjonalności wylogowywania.
