...
@shared.mdc, @frontend.mdc, @database.mdc
</implementation_rules>
...
Teraz wykonaj następujące kroki, aby zaimplementować endpoint interfejsu API REST:

1. Przeanalizuj plan wdrożenia:
   - Określ metodę HTTP (GET, POST, PUT, DELETE itp.) dla endpointu.
   - Określenie struktury adresu URL endpointu
...
2. Rozpocznij implementację:
   - Rozpocznij od zdefiniowania funkcji endpointu z prawidłowym dekoratorem metody HTTP.
